...
- On your server, **Replication Access** (under Backups & Restore) makes a replication token. It is shown once. Token-only mode then refuses the admin password for copying, which is safer.
