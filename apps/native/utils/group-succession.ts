 ...
 *
 * Pure functions only, so the words and the hiding are tested; the PWA carries the same file.
 */
 ...
 */
export function proposalCandidates(silence: GroupSilence, members: GroupMemberItem[]): GroupMemberItem[] {
