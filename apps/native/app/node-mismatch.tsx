...
const styles = StyleSheet.create({
    ...
    currentBox: { backgroundColor: colors.surface.subtle, borderRadius: 10, padding: 12, marginBottom: 20 },
    ...
    input: { backgroundColor: colors.surface.card, borderWidth: 1, borderColor: colors.border.strong, borderRadius: 10, padding: 14, color: colors.text.heading, fontSize: 16, marginBottom: 8 },
    ...
    primaryBtn: { backgroundColor: palette.blue600, borderRadius: 10, padding: 16, alignItems: 'center', marginBottom: 12 },
