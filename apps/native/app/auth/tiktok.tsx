...
/**
 * TikTok OAuth Return Callback Route (The Pulse, Phase 5).
 *
 * Catches the redirect from TikTok Login Kit on Web and Android App Links,
 * completes the auth session, and broadcasts SSO_AUTH_CALLBACK for listeners.
 */
export default function TikTokAuthCallbackScreen() {
    ...
    useEffect(() => {
        try {
            ...
            console.warn('[TikTok Auth Callback] Error completing auth session:', e);
        }
