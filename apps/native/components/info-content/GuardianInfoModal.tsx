                ...
                <View style={styles.tabContent}>
                    ...
                    <View style={styles.processContainer}>
                        ...
                        <View style={{ marginTop: 4 }}>
                            ...
                            <ListItem prefix="4.">When at least <Text style={styles.boldWhiteText}>2 Guardians</Text> (e.g., <Text style={styles.boldWhiteText}>2 out of 3</Text>) approve your recovery request, their approvals combine with your community node to restore your account!</ListItem>
                        </View>
                    </View>
