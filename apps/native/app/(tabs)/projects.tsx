...
export default function ProjectsScreen() {
    ...
    const styles = useStyles(({ theme, colors }) => StyleSheet.create({
        ...
        govCreditsBanner: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: theme === 'dark' ? colors.surface.subtle : palette.indigo100, padding: 12, borderRadius: 12, marginBottom: 12, borderWidth: 1, borderColor: theme === 'dark' ? colors.border.default : palette.indigo200 },
        ...
        statCard: { flex: 1, minWidth: 0, backgroundColor: colors.surface.card, borderRadius: 12, padding: 12, borderWidth: 1, borderColor: colors.border.default },
        ...
        roundBanner: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.feedback.info.bg, borderRadius: 12, padding: 12, marginBottom: 12, borderWidth: 1, borderColor: colors.feedback.info.border },
        ...
        noRoundBanner: { backgroundColor: colors.surface.app, borderRadius: 12, padding: 12, marginBottom: 12, borderWidth: 1, borderColor: colors.border.default },
        ...
        fundedBadge: { position: 'absolute', top: 8, right: 8, backgroundColor: colors.brand.primary, paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6 },
        ...
        votingArea: { backgroundColor: colors.surface.subtle, borderRadius: 12, padding: 12, marginBottom: 16, borderWidth: 1, borderColor: colors.border.default },
        ...
        castBtn: { backgroundColor: colors.brand.primary, paddingHorizontal: 16, paddingVertical: 10, borderRadius: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.1, shadowRadius: 2, elevation: 2 },
                    ...
                    <View style={styles.progressSection}>
                        <View style={styles.progressHeader}>
                            ...
                            <View style={{ alignItems: 'flex-end' }}>
                                ...
                                {item.deadline_at && (
                                    <Text style={{ fontSize: 10, color: getDaysRemaining(item.deadline_at) === 'Expired' ? colors.feedback.danger.solid : colors.accent.primary, marginTop: 2, fontWeight: 'bold' }}>
...
// Styles defined dynamically inside ProjectsScreen component
