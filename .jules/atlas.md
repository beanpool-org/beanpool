...
- `apps/manager/src/lib/ai-client.ts`
...
## 2026-08-08 - [manager tests] ai-client unit tests
**Gap:** loadAiConfig, saveAiConfig, and askAiCopilot in apps/manager/src/lib/ai-client.ts were untested.
**Learning:** Mocking fetch using vi.stubGlobal and stubbing localStorage allows testing local diagnostic fallbacks and multi-provider AI copilot logic cleanly.
**Action:** Look into node-client.ts or component tests for remaining coverage gaps in manager.
