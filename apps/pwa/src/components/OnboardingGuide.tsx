    ...
    return (
        <div className="text-left space-y-4">
            ...
            <div className="p-4 rounded-xl border border-nature-200 dark:border-nature-800 bg-nature-50/50 dark:bg-nature-950/50">
                <h4 className="font-bold text-sm mb-1 text-nature-950 dark:text-oat-50">
                    <span aria-hidden="true">⚡ </span>Energy Exchange Marketplace
                </h4>
                ...
                <div className="mt-3 p-3 rounded-lg border border-emerald-200 dark:border-emerald-900/50 bg-emerald-50/50 dark:bg-emerald-950/20 text-emerald-800 dark:text-emerald-300 text-xs leading-normal">
                    <span aria-hidden="true">🟢 </span><strong>The best place to be is zero (0 Beans).</strong> This means you have given as much value to your community as you have received from it.
                </div>
                <div className="mt-3 p-3 rounded-lg border border-amber-200 dark:border-amber-900/50 bg-amber-50/50 dark:bg-amber-950/20 text-amber-800 dark:text-amber-300 text-xs leading-normal">
                    <span aria-hidden="true">🫘 </span><strong>Contributions First.</strong> To keep the credit pool healthy, you must list at least one Offer of what you can give back before you can post Needs or accept Offers from others.
                </div>
            </div>
            ...
            <div className="p-4 rounded-xl border border-nature-200 dark:border-nature-800 bg-nature-50/50 dark:bg-nature-950/50 space-y-4">
                <h4 className="font-bold text-sm text-nature-950 dark:text-oat-50">
                    <span aria-hidden="true">🪙 </span>The Mutual Credit Ledger
                </h4>
            ...
            <div className="p-4 rounded-xl border border-nature-200 dark:border-nature-800 bg-nature-50/50 dark:bg-nature-950/50">
                <h4 className="font-bold text-sm mb-1 text-nature-950 dark:text-oat-50">
                    <span aria-hidden="true">🔒 </span>Held in Trust
                </h4>
                <p className="text-xs text-nature-600 dark:text-nature-400 leading-relaxed">
            ...
            <div className="p-4 rounded-xl border border-nature-200 dark:border-nature-800 bg-nature-50/50 dark:bg-nature-950/50 space-y-2">
                <h4 className="font-bold text-sm text-nature-950 dark:text-oat-50">
                    <span aria-hidden="true">🚀 </span>Where to Start?
                </h4>
                <p className="text-xs text-nature-600 dark:text-nature-400 leading-relaxed">
                    <span aria-hidden="true">📍 </span>Explore the <strong>Map</strong> to find offers (blue) and needs (orange) near you.
                </p>
                <p className="text-xs text-nature-600 dark:text-nature-400 leading-relaxed">
                    <span aria-hidden="true">💬 </span>Tap <strong>Message</strong> on any post to chat securely (E2E encrypted) with neighbors.
                </p>
                <p className="text-xs text-nature-600 dark:text-nature-400 leading-relaxed">
                    <span aria-hidden="true">➕ </span>Click <strong>Post</strong> to list what you need or what you can offer to the community.
                </p>
                <p className="text-xs text-nature-600 dark:text-nature-400 leading-relaxed">
                    <span aria-hidden="true">💳 </span>Use the <strong>Ledger</strong> tab to send credits to neighbors instantly.
                </p>
            </div>
        </div>
    );
