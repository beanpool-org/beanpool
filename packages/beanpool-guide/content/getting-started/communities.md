...
Your phone holds one account: one name, one key, one set of 12 words. You can use it to join more than one community. Each community keeps its own beans, trades and posts.
