---
slug: enterprises-and-keepers
title: Enterprises, keepers and the commons
summary: Setting up a shared enterprise, choosing who runs it, and the commons pool that pays grants.
related: decisions-and-emergencies, disputes, members-and-invites, roles
---

An enterprise is a shared project with its own account: a community garden, a tool library, a bakery run by several people. The people who run it are its **keepers**.
...
- post an offer or a need in the enterprise's name;
- put it on the map, or take its pin off.

An enterprise must always keep at least one live offer. It cannot vote or propose, and it pays no circulation fee.

## Keepers

A keeper acts for the enterprise from their own app.
...
![The Commons Pool screen in Settings](images/economy-pool.webp)
