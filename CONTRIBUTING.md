...
The project has a working reference implementation across four apps (`apps/server`, `apps/pwa`, `apps/native`, `apps/manager`) plus two shared packages (`@beanpool/core` and `@beanpool/engine`). When contributing code:
